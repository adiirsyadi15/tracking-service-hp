...
<div class="container">
	...
	<div class="row">
		<div class="col-md-6">
				<div class=" pull-left">
					<!--<img src="images/hpindoservice.png" alt="hp indo" class="images_header">-->
	...
	<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				   <ul class="nav navbar-nav navbar-middle">
					  ...
					  <li><a href="imei/cari.php?id_hp="><i class="glyphicon glyphicon-eye-open"></i> Tracking </a></li>
					  <li class="dropdown">
						 <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> HP <b class="caret"></b></a>
					  ...
					  <li class="dropdown">
						 ...
						 <ul class="dropdown-menu" style="padding: 15px;min-width: 250px;">
							<li>
							   <div class="row">
								  <div class="col-md-12">
									 <form class="form" method="post" action="customer_service/login_cs_proses.php" accept-charset="UTF-8" id="login-nav">
										<div class="form-group">
										   <label class="sr-only" for="exampleInputEmail2">username</label>
										   <input type="text" class="form-control" id="exampleInputEmail2" placeholder="User Name" required name="id">
										</div>
										<div class="form-group">
